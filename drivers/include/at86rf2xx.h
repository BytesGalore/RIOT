...
#endif
#if ((AT86RF2XX_DEFAULT_CHANNEL < AT86RF2XX_MIN_CHANNEL)
     || (AT86RF2XX_DEFAULT_CHANNEL > AT86RF2XX_MAX_CHANNEL))
    AT86RF2XX_DEFAULT_CHANNEL (5)
#endif
#else
